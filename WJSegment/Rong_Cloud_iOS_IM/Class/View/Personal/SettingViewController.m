...
-(void)prepareUI {
    ...
    ((UIScrollView*)self.view).contentSize = CGSizeMake([UIScreen mainScreen].bounds.size.width, excNowNumBtn.frame.origin.y+excNowNumBtn.frame.size.height+Group_Margin_Heigth);
