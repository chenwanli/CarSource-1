...
+ (instancetype)cycleScrollViewWithFrame:(CGRect)frame imagesGroup:(NSMutableArray *)imagesGroup;

+ (instancetype)cycleScrollViewWithFrame:(CGRect)frame imageURLStringsGroup:(NSMutableArray *)imageURLStringsGroup;
